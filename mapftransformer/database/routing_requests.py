...
class RoutingRequest:
    ...
    def create_csv_file(
        ...
        """
        Creating routing requests without time csv file. Each routing request contains <num_agent> requests.

        :param directory_path:  The directory path to save the csv file in.
        :param warehouse:       The relevant warehouse.
        :param num_agents:      The number of agents in the warehouse (number of robots), it will affect the dimension of the dataframe.
        :param size:            The number of routing requests.
